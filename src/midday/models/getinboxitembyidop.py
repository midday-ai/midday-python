...
class GetInboxItemByIDRequestTypedDict(TypedDict):
    id: str


class GetInboxItemByIDRequest(BaseModel):
    id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]


class GetInboxItemByIDTransactionTypedDict(TypedDict):
...
class GetInboxItemByIDTransaction(BaseModel):
    r"""Matched transaction for this inbox item, if any"""
...
class GetInboxItemByIDResponseTypedDict(TypedDict):
    r"""Inbox item object"""
    ...
    transaction: Nullable[GetInboxItemByIDTransactionTypedDict]
    r"""Matched transaction for this inbox item, if any"""


class GetInboxItemByIDResponse(BaseModel):
    r"""Inbox item object"""
    ...
    transaction: Nullable[GetInboxItemByIDTransaction]
    r"""Matched transaction for this inbox item, if any"""
