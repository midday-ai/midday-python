...
class CreateTransactionAttachmentTypedDict(TypedDict):
    path: List[str]
...
class CreateTransactionAttachment(BaseModel):
    path: List[str]
    r"""Path(s) of the attachment file(s)."""
...
class CreateTransactionRequestTypedDict(TypedDict):
    ...
    attachments: NotRequired[List[CreateTransactionAttachmentTypedDict]]
...
class CreateTransactionRequest(BaseModel):
    ...
    attachments: Optional[List[CreateTransactionAttachment]] = None
    r"""Array of attachments for the transaction."""
