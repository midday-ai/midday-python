...
class GetBankAccountByIDRequestTypedDict(TypedDict):
    id: str


class GetBankAccountByIDRequest(BaseModel):
    id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]


class GetBankAccountByIDResponseTypedDict(TypedDict):
...
class GetBankAccountByIDResponse(BaseModel):
    r"""A single bank account object response."""
