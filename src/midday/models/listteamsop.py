...
class ListTeamsDataTypedDict(TypedDict):
    id: str
...
class ListTeamsResponseTypedDict(TypedDict):
    r"""Retrieve a list of teams for the authenticated user."""

    data: List[ListTeamsDataTypedDict]
    r"""Array of teams that the user has access to"""


class ListTeamsResponse(BaseModel):
    r"""Retrieve a list of teams for the authenticated user."""

    data: List[ListTeamsData]
    r"""Array of teams that the user has access to"""
